...
bool cViewer::OnInit()
{
	...
	m_observerView->Create(eDockState::DOCKWINDOW, eDockSlot::BOTTOM, this, m_mapView, 0.4f, framework::eDockSizingOption::PIXEL);
	result = m_observerView->Init(m_renderer);
	assert(result);

	//long long aa = common::FileSize("../media/worldterrain/17203_20480.bil");
